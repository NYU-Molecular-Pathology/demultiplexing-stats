...
print_undetermined_rating <- function(avg_undetermined){
    ...
    A <- '\n<span style="color:blue"><big><big><big><big>A</big></big></big></big></span>\n\n'
    B <- '\n<span style="color:green"><big><big><big><big>B</big></big></big></big></span>\n\n'
    C <- '\n<span style="color:yellow"><big><big><big><big>C</big></big></big></big></span>\n\n'
    D <- '\n<span style="color:red"><big><big><big><big>D</big></big></big></big></span>\n\n'
